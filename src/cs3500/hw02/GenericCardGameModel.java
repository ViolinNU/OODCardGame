...
/**
 * This is an interface for a generic card game. It is parameterized over the type of card.
 * It has methods to get a valid deck for this game, start play with the
 * provided deck and number of
...
public interface GenericCardGameModel<K> {
   ...
   * different decks. This method will return a deck of valid playing cards in no particular
   * order.
   *
   ...
   * This method distributes the deck AS IT IS GIVEN amongst the players, in round-robin fashion
   * e.g. if there are 3 players and 52 cards in the deck, player 0 will get card nos 0,3,6,9,..
   * and player 1 will get card nos. 1,4,7,10,... and so on.
   *
   * The deck is to be distributed in the exact sequence as it is provided. Thus, NO SHUFFLING
   * or REORDERING is allowed.
   *
   ...
   * invalid.
   *         The definition of an invalid deck depends on the implementation
   */
   ...
   * italics are comments and do not appear in the string). Replace
